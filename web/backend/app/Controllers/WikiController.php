...
class WikiController extends Controller
{
	...
	public function serveEditWikiPageGetRequest(Request $request, Response $response): Response
	{
	...
	/* GET request with path of the form /a/wiki */
	public function serveGetInfoboxStructureNamesGetRequest( Request $request, Response $response ): Response
	{
		return InfoboxController::getInfoboxStructureNamesResponse( $response );
	}

	public function serveGetInfoboxStructureGetRequest( Request $request, Response $response ): Response
	{
	...
	public function serveModifyInfoboxStructurePostRequest( Request $request, Response $response ): Response
	{
		$stringCheck = \App\Utilities\APIUtilities::$isStringValidator;
		$nonEmptyStringCheck = \App\Utilities\APIUtilities::$isNonEmptyStringValidator;
